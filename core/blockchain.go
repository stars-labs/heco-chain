...
func (bc *BlockChain) insertChain(chain types.Blocks, verifySeals bool) (int, error) {
	...
	for ; block != nil && err == nil || err == ErrKnownBlock; block, err = it.next() {
		...
		log.Info("metric", "method", "validateBlock", "hash", block.Header().Hash().String(), "number", time.Since(substart)-(statedb.AccountHashes+statedb.StorageHashes-triehash))
		...
		log.Info("metric", "method", "writeBlock", "hash", block.Header().Hash().String(), "number", time.Since(substart)-statedb.AccountCommits-statedb.StorageCommits-statedb.SnapshotCommits)
